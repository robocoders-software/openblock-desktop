...
const PrivacyElement = () => (
    <div className={styles.privacyBox}>
        ...
        <p>
            ...
            identified or identifiable individual. The RoboCoders-studio App automatically collects and stores locally the
            following Information through its telemetry system: the title of your project in text form, language
            setting, time zone and events related to your use of the RoboCoders-studio App (namely when the RoboCoders-studio App was
            opened and closed, if a project file has been loaded or saved, or if a new project is created). If you
            choose to turn on the telemetry sharing feature, the RoboCoders-studio App will transmit this information to RoboCoders-studio.
            Projects created in the RoboCoders-studio App are not transmitted to or accessible by RoboCoders-studio.
        </p>
        <h2>How Does RoboCoders-studio Use My Information?</h2>
        <p>We use this Information for the following purposes:</p>
        <ul>
            <li>
                <b>Analytics and Improving the RoboCoders-studio App</b> - We use the Information to analyze use of the RoboCoders-studio
                App and to enhance your learning experience on the RoboCoders-studio App.
            </li>
            <li>
                ...
                policies. We may do this by analyzing your use of the RoboCoders-studio App.
            </li>
        </ul>
        ...
        <p>
            ...
            (if you choose to allow the RoboCoders-studio App to send the RoboCoders-studio team your Information) to create, analyze and
            share your aggregated or de-identified Information for research purposes, to analyze and enhance your
            learning experience on the RoboCoders-studio App and otherwise ensure and improve the safety, security, and
            performance of the RoboCoders-studio App. We only rely on our or a third party’s legitimate interests to process your
            Information when these interests are not overridden by your rights and interests.
        </p>
        <h2>How Does RoboCoders-studio Share My Information?</h2>
        <p>
            We disclose information that we collect through the RoboCoders-studio App to third parties in the following
            circumstances:
        </p>
        <ul>
            <li>
        ...
        <p>
            RoboCoders-studio does not collect information from a student&apos;s education record, as defined by the Family
            Educational Rights and Privacy Act (FERPA). RoboCoders-studio does not disclose information of students to any third
        ...
        <ul>
            ...
            <li>
                ...
                provided in a contract between RoboCoders-studio and you, or (iii) if we have a compelling reason to do so (such
        ...
        <h2>How Does RoboCoders-studio Protect My Information?</h2>
        <p>
            RoboCoders-studio has in place administrative, physical, and technical procedures that are intended to protect the
            Information we collect on the RoboCoders-studio App against accidental or unlawful destruction, accidental loss,
        ...
        <p>
            ...
            the China. (where our RoboCoders-studio servers are located) or any other country in which we or our service
        ...
        <p>
            ...
            revised. Your continued use of the RoboCoders-studio App following these changes means that you accept the revised
            Privacy Policy.
        </p>
        <h2>Contact Us</h2>
        <p>
