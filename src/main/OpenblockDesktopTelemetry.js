...
const APP_ID = 'RoboCoders-studio-desktop';
...
/**
 * Register ipcMain routes once Electron is running (import { ipcMain } at module load can be undefined when bundled).
 */
export function attachTelemetryIpcMain () {
