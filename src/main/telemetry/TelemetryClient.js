...
/**
  ...
  */
// ─── UPDATE TELEMETRY URL HERE ───────────────────────────────────────────────
// Replace the empty string with your Google Sheets Apps Script web app URL
// Example: 'https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec'
const TelemetryServerURL = Object.freeze({
    staging: '',
    production: '' // TODO: paste your telemetry endpoint URL here
});
// ─────────────────────────────────────────────────────────────────────────────
